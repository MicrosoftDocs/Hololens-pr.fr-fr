---
title: forum aux questions sur les appareils HoloLens et les hologrammes
...
ms.locfileid: "126032500"
---
# <a name="holograms-and-interactions-troubleshooting"></a>résolution des problèmes de Hologrammes et d’interactions
...
pour obtenir des conseils sur l’usure de votre HoloLens, consultez [ajuster l’ajustement](hololens2-setup.md#adjust-fit).
...
- [Hologrammes n’avez pas l’aspect approprié ou ne bouge pas](#holograms-dont-look-right-or-are-moving-around)
...
- [Hologrammes disparaissent ou sont encasés dans d’autres hologrammes ou objets](#holograms-disappear-or-are-encased-in-other-holograms-or-objects)
- [Hologrammes apparaissent de l’autre côté d’un mur](#holograms-are-appearing-on-the-other-side-of-a-wall)
...
## <a name="holograms-dont-look-right-or-are-moving-around"></a>Hologrammes n’avez pas l’aspect approprié ou ne bouge pas
...
- essayez de vous rendre à l’gazing et à vos environs afin que les HoloLens puissent les analyser plus complètement.
- Si vous avez placé de nombreux hologrammes, essayez de les supprimer.

Si vous rencontrez toujours des problèmes, essayez d’exécuter l’application d’étalonnage. cette application étalonne vos HoloLens pour vous aider à faire en sorte que vos hologrammes cherchent le mieux. pour ce faire, accédez à **Paramètres**  >    >  **utilitaires** système. Sous **étalonnage**, sélectionnez **ouvrir l’étalonnage**.

[Retour à la liste](#list)

## <a name="finding-your-space-message"></a>Message « recherche de votre espace »

lorsque HoloLens est en cours d’apprentissage ou de chargement d’un espace, vous pouvez voir un message succinct indiquant « recherche de votre espace ». si ce message s’affiche pendant plus de quelques secondes, vous verrez un autre message sous le menu Démarrer qui indique « toujours enquête de votre espace ».

ces messages signifient que HoloLens a des difficultés à mapper votre espace. Dans ce cas, vous pouvez ouvrir des applications, mais vous ne pouvez pas placer des hologrammes dans votre environnement.
...
- Assurez-vous que vous disposez d’un signal Wi-Fi élevé. si vous entrez un nouvel environnement qui n’a pas de Wi-Fi ou un signal Wi-Fi faible, HoloLens ne pourrez pas trouver votre espace. vérifiez votre connexion Wi-Fi en accédant à **Paramètres**  >  **&amp; réseau**  >  **Wi-Fi** Internet.
...
- retirez les hologrammes dont vous n’avez pas besoin en accédant à **Paramètres**  >  **système**  >  **Hologrammes**  >  **supprimer les hologrammes à proximité**. Ou, si nécessaire, sélectionnez **Supprimer tous les hologrammes**.
...
si HoloLens ne pouvez pas mapper ou charger votre espace, il passe en mode limité et vous ne pouvez pas placer d’hologrammes ni voir les hologrammes que vous avez placés. Voici quelques points à essayer :

- assurez-vous qu’il y a suffisamment de lumière dans votre environnement pour HoloLens pouvez voir et mapper l’espace.
...
- Assurez-vous que vous êtes connecté à un réseau Wi-Fi. si vous n’êtes pas connecté à un réseau Wi-Fi, HoloLens ne peut pas identifier et charger un espace connu.
- parcourez les salles afin HoloLens pouvez relancer l’analyse de votre environnement. Pour voir ce qui a déjà été analysé, appuyez sur air pour afficher le graphique de maillage de mappage.
...
- Si l’espace correct est chargé et que vous rencontrez toujours des problèmes, l’espace est peut-être endommagé. Pour résoudre ce problème, sélectionnez l’espace, puis sélectionnez **supprimer**. après avoir supprimé l’espace, HoloLens commence à mapper votre environnement et à créer un nouvel espace.

[Retour à la liste](#list)

## <a name="holograms-disappear-or-are-encased-in-other-holograms-or-objects"></a>Hologrammes disparaissent ou sont encasés dans d’autres hologrammes ou objets
...
les Hologrammes peuvent également être bloqués ou par d’autres hologrammes ou par des objets tels que des murs. Dans ce cas, essayez l’un des correctifs suivants :
...
## <a name="holograms-are-appearing-on-the-other-side-of-a-wall"></a>Hologrammes apparaissent de l’autre côté d’un mur

si vous êtes très proche d’un mur, ou si HoloLens n’a pas encore analysé le mur, vous pouvez voir les hologrammes qui se trouvent dans la salle suivante. Pour numériser le mur, mettez entre un et trois mètres du mur et pointez dessus.

un objet noir ou réfléchissant (par exemple, un canapé noir ou un réfrigérateur en acier inoxydable) à proximité du mur peut causer des problèmes lorsque HoloLens tente d’analyser le mur. S’il y a un tel objet, analysez l’autre côté du mur.
...
- Si le problème persiste, exécutez l’application d’étalonnage. vous le trouverez dans **Paramètres**  >    >  **utilitaires** système.
...
1. activez la télémétrie complète via le **Paramètres** application-> diagnostics de **confidentialité**  ->  **& commentaires** et sous **données de diagnostic facultatives** , vérifiez que le bouton bascule est défini **sur activé**
1. procurez-vous les derniers correctifs d’échelle et de stabilité des hologrammes en mettant à jour le [système d’exploitation 20H2 le plus Windows récent, (ou supérieur)](hololens-release-notes.md#windows-holographic-version-20h2). Après la mise à jour, procédez comme suit :
    1. supprimez tous les Hologrammes via **Paramètres** **système** de > de l’application  ->  **Hologrammes** -> puis sélectionnez **supprimer tous les hologrammes** et commencez avec un nouveau mappage.
    1. créez une nouvelle carte de votre espace en portant les HoloLens et en vous reportant à l’ensemble des zones et des surfaces dans l’espace. Procédez ainsi pendant 2-3 minutes.
    1. Effectuez un étalonnage IPD. accédez à **Paramètres**  >    >  **utilitaires** système. Sous **étalonnage**, sélectionnez **ouvrir l’étalonnage**.
