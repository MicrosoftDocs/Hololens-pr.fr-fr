...
---
# <a name="hololens-2-release-notes"></a>Notes de publication HoloLens 2
...
## <a name="windows-holographic-version-20h2---march-2021-update"></a>Windows Holographic, version 20H2 - Mise à jour de mars 2021
- Build 19041.1140

Améliorations et correctifs de la mise à jour :

- Les clients qui utilisent AdvancedPhotoCapture ou LowLagPhotoCapture pour capturer des photos avec HoloLens 2 peuvent désormais récupérer la pose de l’appareil photo jusqu’à 3 secondes après la capture de la photo.
- Correction d’une fuite de mémoire dans Device Portal Service, le problème a provoqué une augmentation de l’utilisation de la mémoire par le service qui a provoqué l’échec de l’allocation de mémoire par d’autres applications.
- Nous avons résolu un problème dans lequel les utilisateurs inscrits au déploiement par étapes ne peuvent pas se connecter à l’appareil.

## <a name="windows-holographic-version-1903---march-2021-update"></a>Windows Holographic, version 1903 - Mise à jour de mars 2021
- Build 18362.1102
...
## <a name="windows-holographic-version-20h2---february-2021-update"></a>Windows Holographic, version 20H2 - Mise à jour de février 2021
- Build 19041.1136
...
## <a name="windows-holographic-version-1903---february-2021-update"></a>Windows Holographic, version 1903 - Mise à jour de février 2021
- Build 18362.1098
...
## <a name="windows-holographic-version-20h2---january-2021-update"></a>Windows Holographic, version 20H2 - Mise à jour de janvier 2021
- Build 19041.1134
...
## <a name="windows-holographic-version-1903---january-2021-update"></a>Windows Holographic, version 1903 - Mise à jour de janvier 2021
- Build 18362.1091

Cette mise à jour de qualité mensuelle ne contient aucune modification notable. Nous vous encourageons à tester nos dernières versions pour Windows Holographic, version 2004.

## <a name="windows-holographic-version-20h2--december-2020-update"></a>Windows Holographic, version 20H2 – Mise à jour de décembre 2020
- Build 19041.1131
...
## <a name="windows-holographic-version-1903--december-2020-update"></a>Windows Holographic, version 1903 – Mise à jour de décembre 2020
- Build 18362.1088
...
### <a name="whats-new-in-windows-holographic-version-20h2"></a>Nouveautés de Windows Holographic, version 20H2  
...
| [CSP Tenantlockdown et Autopilot](hololens-release-notes.md#tenantlockdown-csp-and-autopilot)                     | Une fois l’inscription du client et la stratégie appliquée, l’appareil ne peut être inscrit dans ce client que chaque fois que l’appareil est réinitialisé ou flashé à nouveau. |
...
| [Lancer automatiquement une application dans une borne multi-applications](hololens-release-notes.md#automatic-launch-of-an-application-in-multiple-app-kiosk-mode)                | Définit une application à lancer automatiquement lors de la signature d’un mode plein écran multi-applications.                                                        |
...
### <a name="auto-eye-position-support"></a>Prise en charge Automatique de la Position des Yeux
...
### <a name="auto-launch-provisioning-from-usb"></a>Mise en service de lancement automatique à partir du port USB
...
### <a name="auto-confirm-provisioning-packages-in-oobe"></a>Confirmer automatiquement les packages d’approvisionnement en mode OOBE
...
### <a name="automatic-provisioning-without-using-ui"></a>Approvisionnement automatique sans utilisation de l’interface utilisateur
- Processus automatiques combinés pour réduire les interactions d’appareil pour l’approvisionnement. 

En combinant le lancement automatique de l’approvisionnement à partir d’appareils USB et la confirmation automatique des packages d’approvisionnement, un utilisateur peut mettre automatiquement en service des appareils HoloLens 2 sans utiliser l’interface utilisateur de l’appareil, ni même porter l’appareil. Vous pouvez continuer à utiliser le même lecteur USB et le même package d’approvisionnement pour plusieurs appareils. Cela est utile pour déployer plusieurs appareils à la fois dans la même zone. 
...
### <a name="using-autopilot-with-wi-fi-connection"></a>Utilisation d’Autopilot avec Wi-Fi connexion
- Suppression du besoin de cartes USB-C pour ethernet réduisant les besoins matériels, en permettant à Autopilot de fonctionner sur Wi-Fi appareils connectés.
...
#### <a name="how-to-set-this-using-intune"></a>Comment définir cette configuration à l’aide de Intune? 
...
#### <a name="how-to-unset-tenantlockdowns-requirenetworkinoobe-on-hololens-2-using-intune"></a>Comment annuler la configuration de RequireNetworkInOOBE de TenantLockdown sur HoloLens2 avec Intune? 
...
#### <a name="what-would-happen-during-oobe-if-autopilot-profile-is-unassigned-on-a-hololens-after-tenantlockdown-was-set-to-true"></a>Que se passe-t-il pendant le processus OOBE, si le profil Autopilot n’est pas affecté sur un HoloLens après la définition de TenantLockdown sur true. 
...
### <a name="cache-azure-ad-group-membership-for-offline-kiosk"></a>Mettre en cache l’appartenance au groupe Azure AD pour kiosque hors connexion
...
### <a name="newly-enabled-update-policies-for-hololens"></a>Stratégies de mise à jour nouvellement activées pour HoloLens
...
### <a name="enabled-settings-page-visibility-for-hololens-2"></a>Visibilité de la page Paramètres activés pour HoloLens 2
...
### <a name="recording-length-increased"></a>Augmentation de la longueur de l’enregistrement
...
## <a name="windows-holographic-version-1903---november-2020-update"></a>Windows Holographic, version 1903 - Mise à jour de novembre 2020
- Build 18362.1085
...
## <a name="windows-holographic-version-2004---october-2020-update"></a>Windows Holographic, version 2004 - Mise à jour d’octobre 2020
- Build 19041.1124
 
Améliorations et correctifs de la mise à jour :

- Suppression d’une vérification inutile à l’origine de la panne du système d’runtime.

## <a name="windows-holographic-version-1903---october-2020-update"></a>Windows Holographic, version 1903 - Mise à jour d’octobre 2020
- Build 18362.1081

Cette mise à jour de qualité mensuelle ne contient aucune modification notable. Nous vous encourageons à tester nos dernières versions pour Windows Holographic, version 2004.

## <a name="windows-holographic-version-2004---september-2020-update"></a>Windows Holographic, version 2004 - Mise à jour de septembre 2020
- Build 19041.1117
...
## <a name="windows-holographic-version-1903---september-2020-update"></a>Windows Holographic, version 1903 - Mise à jour de septembre 2020
- Build 18362.1079
...
## <a name="windows-holographic-version-2004---august-2020-update"></a>Windows Holographic, version 2004 - Mise à jour d’août 2020
- Build 19041.1113

Améliorations et correctifs de la mise à jour :

- L’application Paramètres ne suit plus l’utilisateur dans les expériences d’inscription à l’iris ou d’étalonnage du suivi oculaire.
- Correction d’un bogue dans lequel l’application d’un package d’approvisionnement lors de la OOBE qui renomme l’appareil et effectue d’autres actions (par exemple, la connexion à un réseau) ne peut pas effectuer les autres actions après le redémarrage de l’appareil en raison du changement de nom.
- Modification du jeu de couleurs des flux de configuration initiaux de l’appareil pour améliorer la qualité visuelle.

## <a name="windows-holographic-version-1903---august-2020-update"></a>Windows Holographic, version 1903 - Mise à jour d’août 2020
- Build 18362.1074

Cette mise à jour de qualité mensuelle ne contient aucune modification notable. Nous vous encourageons à tester nos dernières versions pour Windows Holographic, version 2004.

## <a name="windows-holographic-version-2004---july-2020-update"></a>Windows Holographic, version 2004 - Mise à jour de juillet 2020
- Build 19041.1109
...
## <a name="windows-holographic-version-1903---july-2020-update"></a>Windows Holographic, version 1903 - Mise à jour de juillet 2020
- Build 18362.1071
...
## <a name="windows-holographic-version-2004---june-2020-update"></a>Windows Holographic, version 2004 - Mise à jour de juin 2020
- Build 19041.1106
...
- Ajout d’un paramètre dans les hologrammes système des **paramètres**qui permet aux utilisateurs de supprimer automatiquement tous les hologrammes de la maison de réalité mixte lorsque l’appareil  >  ****  >  **** s’arrête.
...
## <a name="windows-holographic-version-1903---june-2020-update"></a>Windows Holographic, version 1903 - Mise à jour de juin 2020
- Build 18362.1064
...
- Nous avons résolu un problème concernant les lancements de l’application Photos initiale après la mise à jour à partir de la version 1903.
...
|       État de l’installation de l’application                 |          Vérifier l’état d’installation dans l’application Paramètres pour les applications ont été poussées vers HoloLens 2 via la gestion des applications mobiles               |
...
### <a name="improved-mdm-enrollment-via-provisioning-package"></a>Amélioration de l’inscription mdm via le package d’approvisionnement
...
### <a name="line-of-business-application-install-status"></a>État d’installation des applications métiers
...
### <a name="additional-csps-and-policies"></a>CSP et stratégies supplémentaires
...
### <a name="expanded-usb-ethernet-support-for-5glte-tethered-devices"></a>Prise en charge étendue d’Ethernet USB pour les appareils connectés 5G/LTE
...
### <a name="hand-tracking-improvements"></a>Améliorations apportées au suivi des mains
...
- **Fiabilité du système :** Nous avons résolu un problème qui provoquait l’arrêt du suivi de la main lorsque l’appareil est en charge élevée.
...
### <a name="system-voice-commands"></a>Commandes vocales système
...
## <a name="windows-holographic-version-1903---may-2020-update"></a>Windows Holographic, version 1903 - Mise à jour de mai 2020 
- Build 18362.1061
...
## <a name="windows-holographic-version-1903---april-2020-update"></a>Windows Holographic, version 1903 - Mise à jour d’avril 2020
- Build 18362.1059
...
## <a name="windows-holographic-version-1903---march-2020-update"></a>Windows Holographic, version 1903 - Mise à jour de mars 2020 
- Build 18362.1056
...
## <a name="windows-holographic-version-1903---february-2020-update"></a>Windows Holographic, version 1903 - Mise à jour de février 2020 
- Build 18362.1053
...
- Amélioration du suivi des mains afin que la partie supérieure de ce doigt soit moins susceptible d’être inattendue lorsque vous faites une recherche avec votre index.
- Fiabilité améliorée du suivi de la tête, du mappage spatial et d’autres runtimes.

## <a name="windows-holographic-version-1903---january-2020-update"></a>Windows Holographic, version 1903 - Mise à jour de janvier 2020 
- Build 18362.1043
...
## <a name="windows-holographic-version-1903---december-2019-update"></a>Windows Holographic, version 1903 - Mise à jour de décembre 2019 
- Build 18362.1042
...
## <a name="windows-holographic-version-1903---november-2019-update"></a>Windows Holographic, version 1903 - Mise à jour de novembre 2019 
- Build 18362.1039

Améliorations et correctifs de la mise à jour :

- Fonctionnalité fixe de sélection **des** commandes vocales lors de la configuration initiale pour en-CA et en-AU.
- Amélioration de la qualité visuelle des objets placés loin dans les dernières versions d’Unity Shared Computer Toolkit (MRTK).
