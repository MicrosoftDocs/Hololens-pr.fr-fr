...
description: Guide d’utilisation de HoloLens 2 avec vos mains
...
- Navigation dans Windows 10 sur HoloLens (Windows Holographique)
...
HoloLens est doté de capteurs qui peuvent voir à quelques centimètres autour de vous. Lorsque vous utilisez les mains, vous devez les conserver à l’intérieur de ce cadre, sinon HoloLens ne les verra pas. Toutefois, le cadre se déplace lorsque vous vous déplacez.  
...
Pour afficher un **menu contextuel**, que vous trouvez par exemple sur une vignette d’application du menu Démarrer, **appuyez longuement** dessus, comme sur un écran tactile.

## Utiliser un rayon émanant de la main pour les hologrammes inaccessibles
...
### Saisir en cliquant longuement dans l’air
...
## Mouvement associé au menu Démarrer

> [!VIDEO https://www.microsoft.com/videoplayer/embed/RE3Wxng]

Le mouvement associé au menu Démarrer ouvre le **menu Démarrer**.  Pour effectuer le mouvement associé au menu Démarrer, tendez votre main, paume vers vous. Une **icône de démarrage** s’affiche au-dessus de votre poignet interne. Appuyez sur cette icône avec votre autre main.  Le menu Démarrer s’ouvre à l’**endroit que vous regardez**.

> [!TIP]
>
> - Vous pouvez utiliser le mouvement associé au menu Démarrer tant que vos mains se trouvent dans le cadre de suivi de la main.  Vous n’avez pas besoin de regarder l’icône Démarrer. Gardez votre coude en position basse et confortable et regardez la direction dans laquelle vous voulez que le menu Démarrer s’ouvre.
> - Si le menu Démarrer ne s’ouvre pas à la position de votre choix, déplacez simplement votre tête pour le repositionner.
> - Si vous rencontrez des difficultés pour lire le texte plus petit dans le menu Démarrer, rapprochez-vous du menu lorsqu’il est ouvert.
> - Si votre main est légèrement en-dehors du côté du cadre, vous pouvez peut-être tout de même afficher le menu Démarrer en appuyant sur l’intérieur de votre poignet, même si vous ne voyez pas l’icône.
...
Tout comme le PC Windows démarre toujours son expérience sur un ordinateur de bureau, HoloLens démarre toujours en mode **maison virtuelle** lorsqu’il est activé.  Le menu Démarrer, permet d’ouvrir et de placer des fenêtres d’application, ainsi que des lanceurs d’applications et du contenu 3D dans la maison virtuelle. Leur emplacement dans votre espace physique sera mémorisé par HoloLens.
...
Paramètres est un exemple d’application HoloLens qui utilise une **fenêtre d’application**2D.  Elle est très similaire à une application Windows sur PC.
...
Dans la maison virtuelle, vous pouvez déplacer, redimensionner et faire pivoter les fenêtres d’application et les objets 3D à l’aide de vos mains, du rayon émanant de la main et de commandes vocales.
...
### Redimensionnement d’hologrammes
...
Si vous souhaitez redimensionner la fenêtre d’une application de manière à afficher **davantage de contenu** dans la fenêtre, utilisez les poignées de redimensionnement qui se trouvent sur les côtés et bords inférieurs de la fenêtre de l’application.

Il existe deux façons de redimensionner un hologramme plus éloigné de vous. Vous pouvez, soit saisir deux coins de l’hologramme, soit utiliser les commandes de redimensionnement.

### Faire pivoter des hologrammes
...
### Me suivre, arrêter le suivi

Les hologrammes et les fenêtres de l’application restent aux endroits où vous les avez placés dans le monde.  Cela n’est pas toujours pratique si vous devez vous déplacer et que vous voulez qu’une application reste visible. Pour demander à une application de commencer ou d’arrêter de vous suivre, sélectionnez **Me suivre** dans l’angle supérieur droit de la fenêtre de l’application (en regard du bouton **Fermer** ).  Une fenêtre d’application qui vous suit vous suit également dans (et hors de) une application immersive.

## Utiliser HoloLens avec votre voix

Vous pouvez utiliser votre voix pour effectuer la plupart des opérations que vous effectuez avec les mains dans HoloLens, par exemple, prendre rapidement une photo ou ouvrir une application.
