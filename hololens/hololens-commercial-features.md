...
Qu’est-ce qui rend HoloLens 2 si puissant ?

| Fonctionnalité | Description |
|---------|-------------|
| Ancrage du monde | Les hologrammes ancrés restent précisément en place. HoloLens 2 comprend votre espace de travail. Ainsi, le contenu numérique est ancré aux objets ou aux surfaces où vous travaillez et persiste au fil du temps. |
| Suivi de la main | Touchez, saisissez et déplacez des hologrammes de façon naturelle. HoloLens 2 s’adapte à vos mains pour une satisfaction retrouvée dans vos interactions. |
| Eye-tracking | Profitez d’un nouveau niveau de contexte et de compréhension humaine. HoloLens 2 comprend précisément où vous regardez. Il peut donc déterminer votre intention et adapter les hologrammes à vos yeux en temps réel. |
| Voix activée | Les commandes vocales intégrées vous permettent de naviguer rapidement dans HoloLens 2 et de le faire fonctionner quand vos mains sont occupées par une tâche. |
| Ergonomique | HoloLens 2 est un appareil léger (3,28 kg), équipé d’un système de réglage à molette pour une utilisation prolongée. |
| Grand champ de vision | Étendez votre canevas holographique avec un affichage haute résolution à grand champ de vision. |
| Sans fil | Déplacez-vous librement, sans câble ni pack externe susceptible de vous gêner au travail. |
| Technologie Azure | Diffusez en streaming du contenu 3D haute fidélité et ancrez-le à un emplacement et/ou un objet persistant au fil des utilisateurs grâce aux services de réalité mixte d’Azure.
| MRC (Mixed Reality Capture) | Documentez une expérience sous la forme d’une photo ou d’une vidéo à partager avec d’autres personnes en temps réel. |
| Windows Hello Entreprise | L’authentification biométrique basée sur l’iris vous permet d’accéder rapidement et en toute sécurité au flux du travail. |
| Windows Autopilot | Installez et préconfigurez les services de HoloLens 2 pour qu’ils soient prêts à être utilisés immédiatement sur les lieux de travail distants. |
| Mises à jour de système d’exploitation | Assurez la sécurité avec des mises à jour de maintenance mensuelles et tirez parti des nouvelles fonctionnalités de productivité et de gestion dans les versions semestrielles. |
...
| Afficher ou masquer des applications spécifiques dans le menu Démarrer |[**Mode plein écran**](hololens-kiosk.md) | Configurez HoloLens 2 pour qu’il fonctionne comme un appareil à usage fixe pour une utilisation dans les démonstrations d’application ou les applications métier dédiées. 
| Sécuriser mon environnement en verrouillant des applications | [**WDAC**](windows-defender-application-control-wdac.md) | Windows Defender Application Control (WDAC) empêche l’utilisateur de l’appareil de lancer des applications et des processus.
| Gérer la sécurité des appareils avec des règles pour les applications et les processus | [**Politiques (CSP)**](hololens-csp-policy-overview.md) | Les administrateurs informatiques peuvent définir et implémenter des paramètres de stratégie au moyen d’une liste existante de fournisseurs CSP de stratégie sur HoloLens 2. |  
| Gérer la connexion d’un appareil à Internet | [**Réseau et connectivité**](hololens-certificates-network.md) | Utilisez l’authentification basée sur les certificats pour accéder à des ressources Wi-Fi, VPN ou internes. | 
| Partager l’appareil avec plusieurs utilisateurs | [**Affichage personnalisé automatiquement**](hololens-calibration.md#auto-eye-position-support) | L’affichage de l’HoloLens 2 est automatiquement ajusté avec la fonctionnalité AEP (Auto Eye Position), ce qui évite d’avoir à étalonner manuellement l’appareil lorsqu’il est [partagé entre plusieurs utilisateurs](hololens-multiple-users.md). |

Découvrez-en plus sur les [conditions d’octroi de licence](hololens-licenses-requirements.md) pour les solutions ci-dessus.

## <a name="next-steps"></a>Étapes suivantes
> [!div class="nextstepaction"]
> [Explorer les options de HoloLens 2](hololens2-options.md)

> [!div class="nextstepaction"]
>[Planification du déploiement de HoloLens 2](hololens-requirements.md) 
