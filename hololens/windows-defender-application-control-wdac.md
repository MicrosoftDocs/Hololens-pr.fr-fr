...
pour les administrateurs informatiques qui cherchent à mettre à jour leur [stratégie WDAC](windows-defender-application-control-wdac.md) pour bloquer le [nouvel Microsoft Edge application](hololens-new-edge.md), vous devez ajouter les éléments suivants à votre stratégie.
...
1. ouvrez Paramètres > mises à jour & Security-> pour les développeurs et activez le **mode développeur** , puis le portail de l' **appareil**.
   ...
   Pour plus d’informations et pour obtenir des instructions, consultez [configurer et utiliser le portail de l’appareil ici](/windows/mixed-reality/develop/platform-capabilities-and-apis/using-the-windows-device-portal).
