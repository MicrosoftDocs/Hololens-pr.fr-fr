...
## [Qu’est-ce que l’HoloLens 2 peut faire pour vous ?](hololens-commercial-features.md)
...
#### [Nouvelle application Paramètres](hololens-new-settings.md)
#### [Nouveau Microsoft Edge](hololens-new-edge.md)
### Gérer des applications
#### [Rechercher, installer et désinstaller des applications du Store](holographic-store-apps.md)
...
#### [Déplacement de plateformes](hololens2-moving-platform.md)
### Connecter votre HoloLens 2
...
# Déploiement de HoloLens 2
## [Scénarios courants de déploiement](hololens-requirements.md)
## [Planification du déploiement de HoloLens 2](hololens-core-components.md)
...
# Dépannage
## [Appareil](hololens-troubleshooting.md)
## [Hologrammes et interactions](hololens-faq.md)
## [Affichage](hololens2-display.md)
## [Implémentation et appareils managés](hololens2-enterprise-troubleshooting.md#)
## [Activer les journaux de diagnostic](hololens-diagnostic-logs.md)
## [Réinitialiser HoloLens 2](hololens-recovery.md)

# Ressources
## [Où acheter HoloLens 2](hololens2-purchase.md)
...
## [En savoir plus sur Microsoft Mesh (version préliminaire)](/mesh/overview)
...
### Sécurité de HoloLens (1re génération)
#### [Questions de sécurité fréquemment posées sur HoloLens (1re génération)](hololens1-faq-security.yml)
#### [Chiffrement BitLocker HoloLens (1re génération)](hololens1-encryption.md)
### [Problèmes connus et solutions de contournement pour HoloLens (1ère génération)](hololens-known-issues.md)
